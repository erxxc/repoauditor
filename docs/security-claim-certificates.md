...
Current certificate version: `security_claim_v3`  
Current verifier: `python_local_certificate_checker_v3`
...
Unsupported languages, cross-file paths, path predicates, missing immutable snapshots, or
incomplete certificates remain incomplete/unsupported rather than being guessed.
