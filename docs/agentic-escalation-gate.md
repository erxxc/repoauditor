...
7. **Independent verification — partial.** Agent-produced claims use the persisted
   ...
   supported facts without consuming the producer's evidence object. Version 7 additionally
   ...
   SSRF request-input-to-`fetch` syntax; other JS/TS mechanisms remain unsupported. The
   agent never verifies its own claim.
