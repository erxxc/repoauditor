...
VI. Deterministic scanner assurance and capability
   ...
   P. OPT-037 — Calibration evidence — closed — owner: project governance / quantitative
      ...
      claims. Tier 0 subsequently reproduced the exact-oracle aggregate coverage boundary.
      Tier 1 reported descriptive reliability over 104 temporally valid authoritative
      outcomes across 15 evaluation families (Brier 0.209421; fixed ten-bin ECE 0.213942).
      Tier 2 remains explicitly unavailable because its estimator and independent-reference
