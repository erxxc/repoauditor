"""OPT-003 wave review is bounded, score-blind, abstention-safe, and non-mutating."""
...
from repoauditor.eval.temporal_review import _stored_rows, render_review


ROOT = Path(__file__).resolve().parents[1]
RECEIPT = ROOT / "docs/optimizations/opt-003-wave-1-review-receipt-2026-08-11.json"
