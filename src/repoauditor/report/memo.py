...
_METHODOLOGY = (
    ...
    "appendix come from a FAIR-style organization-level Monte Carlo model. The IRIS "
    "all-event annual frequency is consumed once per organization-year; findings and their "
    "validity provenance remain audit context and do not allocate or multiply that rate. "
    "EPSS and KEV are eligible only as real, dated signals for a CVE-backed finding; "
